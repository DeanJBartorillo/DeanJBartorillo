...
<br><br>
It is also worth your time to explore the [difference between data science, and data analytics](https://medium.com/@springboard_ind/data-science-vs-data-analytics-how-to-decide-which-one-is-right-for-you-41e7bdec080e). 
...
### Course Platforms
I was surprised to find out how many free courses there are out there. Here is a list of some of the platforms where you can find numerous free courses: <br><br>
...
<br>[Programming for Everybody (Getting Started with Python)](https://www.coursera.org/learn/python): This course by the U of Michigan has been suggested to me numerous times for learning Python. It is on Coursera- so that $50/mo subscription will cover the whole course.
...
I will be honest with you, I copy and pasted the following right from the course: <br>
...
<br> So far, I only have a couple of text files/decision trees that I think are really helpful and want to share with you about data visualizations/Tableau. [Click here](https://anniesanalytics.wixsite.com/annie-nelson/general-9) to go to this website where you can download these files (for free, of course, no weird software downloads or anything, I just can't add them to my page here easily). Scroll to "#3- Visualization Files"

## Tableau Basics
[My Tableau CheatSheet](https://www.linkedin.com/feed/update/urn:li:activity:6950033793013469184/): I am planning on taking a [Maven Analytics Course](https://www.mavenanalytics.io/course/intro-tableau-desktop) that was suggested by another DA to give me all the basics I could possibly need to know about Tableau. Below is a cheat sheet of notes from the course.
...
Read these resources. They're free.
...
# Python :snake:
I haven't learned Python yet, but will add more when I do learn it! Besides the courses linked above, all I have to add is [this tutorial](https://www.kaggle.com/kanncaa1/data-sciencetutorial-for-beginners ) for beginners.

<br><br> More information about R vs Python. 
...
* [Maven Analytics Data Playground](https://www.mavenanalytics.io/data-playground): If you take nothing else out of this guide, take this. These datasets are specifically curated for beginner data analysts to build their portfolio.
